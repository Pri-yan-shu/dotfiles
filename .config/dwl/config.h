...
#define WMKEYS(KEY,SKEY,TAG) \
	...
	{ ALT|SHIFT,              SKEY,           toggleview,      {.ui = 1 << TAG} }, \
	{ SUPER, 		              KEY,            tag,             {.ui = 1 << TAG} }, \
	{ SUPER|SHIFT,            SKEY,						toggletag,			 {.ui = 1 << TAG} }
...
static const Key keys[] = {
	...
	// { ALT,                    XKB_KEY_k,          incnmaster,     {.i = -1} },
	{ SUPER,                  XKB_KEY_Left,       setmfact,       {.f = -0.05f} },
	{ SUPER,                  XKB_KEY_Right,      setmfact,       {.f = +0.05f} },
	// { SUPER,                  XKB_KEY_Home,       focusstack,     {.i = -1} },
	// { SUPER,                  XKB_KEY_End,        focusstack,     {.i = +1} },
